...
| 模型 | ORT 1.21.1 (t=1) | ORT 1.21.1 (t=8) | ORT 1.24.3 (t=1) | ORT 1.24.3 (t=2) | KleidiAI 加速 (t=1) |
|-------|-------------------:|------------------:|------------------:|------------------:|:---:|
| doc_ori | 6.53 | 6.63 | 6.68 | **3.41** | 0.98x |
| det | 4,876.13 | **1,328.30** | 5,440.39 | 4,246.58 | 0.90x（退化） |
...
| 图片 | 文本数 | ORT 1.21.1 (t=1) | ORT 1.21.1 (t=8) | ORT 1.24.3 (t=1) | ORT 1.24.3 (t=2) |
|-------|:-----:|------------------:|------------------:|------------------:|------------------:|
